 ...
 * Usage example:
 * <pre>
 * models.World w = new models.World();
 *
 * models.Turtle t = new models.Turtle(w);
 * t.forward(300);
 * t.setPenWidth(10);
 * t.backward(100);
 * t.right(135);
...
public class Turtle {
     ...
     * Should only be called by models.World class
    ...
    /**
     * Returns the current Color of the models.Turtle.
    ...
    /**
     * Changes the current Color of the models.Turtle.
    ...
    /**
     * Find out what direction the models.Turtle is facing
    ...
    /**
     * Set the direction the models.Turtle is facing
