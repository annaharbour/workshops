 ...
 * Usage example:
 * <pre>
 * models.World basic = new models.World();
 * models.World fancy = new models.World(640, 480, Color.YELLOW);
 *
 * models.Turtle t1 = new models.Turtle(basic);
 * models.Turtle t2 = new models.Turtle(fancy);
 *
 * t1.forward(100);
 * basic.erase();
 * t1.turnLeft(90);
...
public class World extends JFrame {
    ...
    /**
     * Creates a new models.World for Turtles to play in.
     */
    public World() {
        this(600, 600);
    }
    ...
    public World(int width, int height, Color backgroundColor) {
        super("models.Turtle models.World");
    ...
    /**
     * Should only called by the models.Turtle class constructor
     */
    ...
    /**
     * Should only called by models.Turtle class methods
     */
    ...
    /**
     * To be used by models.Turtle class only
     *
